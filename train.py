...
def get_dataloader(config):
    if config['dataset'] == 'mnist':
        train_dataset=torchvision.datasets.MNIST(root="/home/zihao/dataset",train=True,transform=transforms.ToTensor(),download=True)
        test_dateset=torchvision.datasets.MNIST(root="/home/zihao/dataset",train=False,transform=transforms.ToTensor(),download=True)
        config['img_size'] = 28
        ...
        train_dataset=torchvision.datasets.CIFAR10(root="/home/zihao/dataset",train=True,transform=transform_train,download=True)
        test_dateset=torchvision.datasets.CIFAR10(root="/home/zihao/dataset",train=False,transform=transform_test,download=True)
        config['img_size'] = 32
